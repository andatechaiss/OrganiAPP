...
public interface CalendarRPCAsync {
	...
	void addAcl(String token, String calendarID, Acl acl, AsyncCallback<String> callback);
	...
	void getAll(String token, AsyncCallback<List<Calendars>> callback);

	void addCalendar(String token, Calendars calendar, AsyncCallback<String> callback);
	...
	void getAll(String token, String calendarID, AsyncCallback<List<CalendarEvent>> callback);

	void addCalendarEvent(String token, String calendarID, CalendarEvent event, AsyncCallback<String> callback);
